...
app = modal.App(
    name="daily_memes",
    image=modal.Image.debian_slim().pip_install("discord.py", "requests"),
)
...
def make_request(subreddit, secret=modal.Secret.from_name("daily-discord-memes")):
    ...
    headers = {"Authorization": "bearer " + bearer_token, "User-Agent": "DM by someguy"}
...
@app.function(
    secrets=[modal.Secret.from_name("daily-discord-memes")],
